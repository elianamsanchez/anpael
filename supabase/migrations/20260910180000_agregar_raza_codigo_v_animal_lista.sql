-- Padrón: mostrar el código de raza (AA, CAR, HER) en vez del nombre completo.
--
...
values ('20260910180000_agregar_raza_codigo_v_animal_lista')
on conflict (version) do nothing;

-- Comprobación: la vista sigue devolviendo una fila por animal y trae el código.
select id_animal, raza, raza_codigo from v_animal_lista limit 5;
select
